   ...
   <section class="w-full flex justify-center bg-color5 h-auto">
        <div class="w-full container flex justify-between flex-wrap px-0 2xl:px-36 h-auto py-16 ">
                <div class="w-full lg:w-[50%]  bg-color px-5 ">
                        <p class="text-color4 uppercase">Multiple award winning travel company</p>
        ...
        <div class="w-full container 2xl:px-36 py-16 bg-color7 ">
                ...
                <div class="w-full flex lg:relative py-10 flex-wrap lg:px-3 xl:px-0 px-6">
                        ...
                        <div class="w-full lg:w-[50%] lg:absolute lg:h-[400px] bg-map bg-no-repeat bg-center z-10 lg:right-0 xl:top-[170%] md:top-20 px-10 py-16 bg-white" >
                                ...
                                <p class="text-color6">You can choose any country with good tourism like Colosseum, Amphitheatre in Rome Italy.</p>
                                <div class=" flex flex-wrap py-4 ">
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">France</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Germany</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Spain</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Greece</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Denmark</p></div>
                                        <div class="flex w-[33%]"><i class="bi bi-geo-alt text-color1"></i><p class="text-color6">Austria</p></div>
                                        
                                </div>
                                <a href="https://www.booking.com/searchresults.en-gb.html?aid=347349&label=msn-LHixTWR%2AmGhK0FPsaHabeA-79989631786043%3Atikwd-79989785570468%3Aloc-137%3Aneo%3Amte%3Alp152626%3Adec%3AqsColosseum&utm_campaign=Italy&utm_medium=cpc&utm_term=LHixTWR%2AmGhK0FPsaHabeA&msclkid=26d444e9cf621796974b2225d7d09949&utm_source=bing&utm_content=Roma%20-%20Colosseum%20-%20D%3A2101&dest_type=district&redirected=1&dest_id=2101&source=district&from_district=1&keep_landing=1&sid=a4105d8c932e9cec5cdbdab842a1c3f7" class="capitalize flex py-4 relative  text-color1 before:content-[''] before:h-[1px] before:absolute before:w-[100%] before:bg-color6 before:bg-opacity-50 before:top-0"><p>view places to stay in Colosseum</p><i class="bi bi-arrow-right"></i></a>
